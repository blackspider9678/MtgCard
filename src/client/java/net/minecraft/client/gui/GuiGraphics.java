...
public final class GuiGraphics {
    ...
    public int text(Font font, String text, int x, int y, int color) {
        delegate.text(font, text, x, y, color);
        return x + font.width(text);
    }

    public int text(Font font, String text, int x, int y, int color, boolean shadow) {
        delegate.text(font, text, x, y, color, shadow);
        return x + font.width(text);
    }

    public int text(Font font, Component text, int x, int y, int color) {
        delegate.text(font, text, x, y, color);
        return x + font.width(text);
    }

    public int text(Font font, Component text, int x, int y, int color, boolean shadow) {
        delegate.text(font, text, x, y, color, shadow);
        return x + font.width(text);
    }

    public int text(Font font, FormattedCharSequence text, int x, int y, int color) {
        delegate.text(font, text, x, y, color);
        return x + font.width(text);
    }

    public int text(Font font, FormattedCharSequence text, int x, int y, int color, boolean shadow) {
        delegate.text(font, text, x, y, color, shadow);
        return x + font.width(text);
    }
