...
public final class MtgGameEnabledResourceCondition implements ResourceCondition {
    private static final ResourceConditionType<MtgGameEnabledResourceCondition> TYPE =
            ResourceConditionType.create(ModRegistry.id("mtg_game_enabled"), MapCodec.unit(MtgGameEnabledResourceCondition::new));
