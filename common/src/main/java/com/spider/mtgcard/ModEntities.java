...
public final class ModEntities {
    ...
    public static final EntityType<CardDisplayEntity> CARD_DISPLAY =
            EntityType.Builder
    ...
    public static final EntityType<DiceEntity> D6_DICE = buildDie(D6_DICE_KEY);
    public static final ResourceKey<EntityType<?>> D4_DICE_KEY = ResourceKey.create(Registries.ENTITY_TYPE, D4_DICE_ID);
    public static final EntityType<DiceEntity> D4_DICE = buildDie(D4_DICE_KEY);
    ...
    private static EntityType<DiceEntity> buildDie(ResourceKey<EntityType<?>> key) {
        return EntityType.Builder.<DiceEntity>of(DiceEntity::new, MobCategory.MISC)
